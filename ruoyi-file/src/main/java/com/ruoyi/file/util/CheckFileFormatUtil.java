...
public class CheckFileFormatUtil {
    ...
    // 缓存文件头信息-文件夹
    public static final HashMap<String, String> folder = new HashMap<String, String>();
    static {
        // images
    ...
    static {
    	...
    	folder.put("zip", "reduce");
    	folder.put("rar", "reduce");
    	
    	folder.put("mp4", "video");
    	folder.put("mpg", "video");
 
    	folder.put("mp3", "audio");
    	folder.put("mid", "audio");
...
//		System.out.println(builder.toString());
    ...
    public static void main(String[] args) throws Exception {
       /* final String fileType = getFileType(null);
        System.out.println(fileType);*/
        File f=new File("C:\\Users\\Administrator\\Desktop\\PhpStudy20180211.zip");
        FileInputStream fg=new FileInputStream(f);
        System.out.println(getFileType(fg));
        //System.out.println(getFileHeader(fg));
        
        Iterator ui=mFileTypes.entrySet().iterator();
        while (ui.hasNext()) {
